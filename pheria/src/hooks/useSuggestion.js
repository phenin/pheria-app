...
export function useSuggestion(limit) {
    ...
    const fetchSuggestion = async () => {
        ...
        const asyncFetchUser = async (userX, type) => {
        ...
        const recentInteractionTasks = recentInteractionsForTask
        ...
        Promise.all(recentInteractionTasks
            ...
            Promise.all(followedByInteractionTasks).then(result2 => {
                ...
                Promise.all(followerOfFollowingUsernameTasks).then(resultTemp => {
                    ...
                    const followerOfFollowingsTasks= followedByFollwers
