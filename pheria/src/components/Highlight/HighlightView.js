...
import { Animated, KeyboardAvoidingView, StyleSheet, Text, TouchableHighlight, TouchableOpacity, View, Image } from 'react-native'
...
const HighlightView = ({ highlight, isMyHighlight }) => {
    ...
    const stopAnimation = (allowCallback = false) => {
