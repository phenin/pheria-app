                ...
                state.listBackground.map((item, index) => {
                  ...
                  if(item.backgroundColor.length >= 2) {
                    backgroundColor = {linearGradient: {
                      colors: [item.backgroundColor[0], item.backgroundColor[1]],
                      start: [0, 0],
                      end: [1, 0],
                    }}
                  }
                  ...
                  return (
                    <TouchableOpacity onPress={()=>selectBackground(item)} key={index}>
                      <Box width={10*vh} height={25*vw} bg={backgroundColor}
